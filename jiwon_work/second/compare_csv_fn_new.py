...
def compare_with_sample_csv_fn(curr_folder_name, CURRENT_CSV_FILE_NAME):
    ...
    curr_csv = pd.read_csv(os.path.join(os.path.pardir, curr_folder_name, CURRENT_CSV_FILE_NAME))
...
def compare_with_prev_csv_fn(prev_folder_name, PREV_CSV_FILE_NAME, curr_folder_name, CURRENT_CSV_FILE_NAME):
    ...
    prev_csv = pd.read_csv(os.path.join(os.path.pardir, prev_folder_name, PREV_CSV_FILE_NAME))
    curr_csv = pd.read_csv(os.path.join(os.path.pardir, curr_folder_name, CURRENT_CSV_FILE_NAME))
